...
def wsgi_xmlrpc(environ, start_response):
    ...
    if environ['REQUEST_METHOD'] == "OPTIONS":
        ...
        response.headers['Access-Control-Allow-Headers'] = 'origin, x-csrftoken, content-type, set_cookie, X-Sid, accept'
        response.headers['Access-Control-Expose-Headers'] = 'origin, x-csrftoken, content-type, set_cookie, X-Sid, accept'
