    ...
    def _get_origin(self, request_origin):
        ...
        if request_origin:
            ...
            if not allowed_origins:
                allowed_origins = 'localhost,nempos.com,int.nempos.com,nempos.delivery,nempos.cloud,sareca.net,nemesix.it'
                ...
                _logger.debug('Allowed Origins = localhost,nempos.com,int.nempos.com,nempos.delivery,nempos.cloud,sareca.net,nemesix.it')
